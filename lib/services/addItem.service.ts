...
export const postItem = async (seller_id: string,itemData: RegisterItemDTO): Promise<ItemInfo> => {
    const {item_title,item_description,item_price,item_location,item_images,category_id} = itemData;
    ...
    const result = await pool.query(
        ...
        [ seller_id,item_price,item_title,item_description,item_location,item_images,category_id ]
    )
