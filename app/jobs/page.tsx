                ...
                <div className="flow-root">
                    <div className="flex items-center bg-white border border-gray-300 rounded-full px-3 py-2 w-[900px] h-12">
                        <div className="relative min-w-[90px] pointer-events-auto">
                            <select className="appearance-none bg-transparent pr-6 pl-1 text-gray-700 text-sm focus:outline-none relative z-10">
                                <option>알바</option>
                                <option>중고거래</option>
                                <option>동네생활</option>
                            </select>
            ...
            <div className="flex gap-13">
                <div className="flex-flow w-1/5">
                    <div className="flex justify-between items-center pb-5">
                        ...
                        <p className="text-sm font-bold text-gray-400 ml-auto underline">
                            초기화
                        </p>
                    </div>
