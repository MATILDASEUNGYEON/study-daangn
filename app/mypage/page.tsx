                    ...
                    <div className='flex flex-wrap gap-4 justify-center'>
                        ...
                        >
                            <div className='flex gap-4 pb-3'>
                                <Image src={storageIcon} alt="storageIcon" className='size-6'/>
                        ...
                        >
                            <div className='flex gap-4 pb-3'>
                                <Image src={likeIcon} alt="likeIcon" className='size-6'/>
                        ...
                        >
                            <div className='flex gap-4 pb-3'>
                                <Image src={writeIcon} alt="listIcon" className='size-6'/>
                        ...
                        >
                            <div className='flex gap-4 pb-3'>
                                <Image src={chatIcon} alt="chatIcon" className='size-6'/>
